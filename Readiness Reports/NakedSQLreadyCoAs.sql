...
SELECT TESTID,BATCHNUMBER,PKGLOT,BLISTERLOT,PRODUCT, FORMULATIONID,CUSTOMER,
    To_Char(TO_DATE(SUBSTR(RECEIVEDDATE,0,8),'YYYYMMDD'),'MM/DD/YY') AS DATERECEIVED, To_Char(To_Date(SUBSTR(FINISHEDDATE,0,8),'YYYYMMDD'),'MM/DD/YY') AS DATEFINISHED,
    REQUESTSTATUS,
