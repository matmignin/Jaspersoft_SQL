...
-- where tests are pending/in progress and don't have a CoA report
WHERE UPPER(TRIM(TESTID)) <> 'COA REPORT'
AND TESTSTATUS NOT IN (800,1000,5000) -- not canceled, completed, or Finished
